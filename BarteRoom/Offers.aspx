                  ...
                  <h2><asp:Label ID="bid_header" Text="Offers List" Font-Bold="true" runat="server" /></h2> <br />
                       ...
                       <Columns>
                           ...
                           <asp:TemplateField HeaderText="Bidder" ShowHeader="False">
                               <ItemTemplate>
                                    <asp:LinkButton ID="LinkButton4" CssClass="change" CommandName="Select" runat="server"><asp:Label ID="Label3" runat="server" Text='<%# Bind("Bidder") %>'></asp:Label></asp:LinkButton>
                               </ItemTemplate>
                                  <HeaderTemplate>
                                 <asp:LinkButton ID="btnRandom4" runat="server" CssClass="btn btn-primary"  Width="100%">
                                <span aria-hidden="true" class="glyphicon glyphicon-user"></span>
                                  <asp:Label ID="Lbl2" runat="server" Text="Bidder"></asp:Label></asp:LinkButton>
                                 </HeaderTemplate>
                               <ItemStyle Font-Bold="True" Font-Size="Large" ForeColor="#3366CC" />
                           </asp:TemplateField> 
